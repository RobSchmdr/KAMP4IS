...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>IS Modify Required Role</b></em>'.
 * <!-- end-user-doc -->
 * @generated
 */
public class ISModifyRequiredRoleTest extends ISModifyRoleTest {
	...
	/**
	 * Constructs a new IS Modify Required Role test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public ISModifyRequiredRoleTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this IS Modify Required Role test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	protected ISModifyRequiredRole getFixture() {
		return (ISModifyRequiredRole)fixture;
	}
