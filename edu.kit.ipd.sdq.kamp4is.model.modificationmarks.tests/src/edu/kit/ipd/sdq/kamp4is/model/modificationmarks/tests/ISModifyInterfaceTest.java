...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>IS Modify Interface</b></em>'.
 * <!-- end-user-doc -->
 * @generated
 */
public class ISModifyInterfaceTest extends ISModifyEntityTest {
	...
	/**
	 * Constructs a new IS Modify Interface test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public ISModifyInterfaceTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this IS Modify Interface test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	protected ISModifyInterface getFixture() {
		return (ISModifyInterface)fixture;
	}
