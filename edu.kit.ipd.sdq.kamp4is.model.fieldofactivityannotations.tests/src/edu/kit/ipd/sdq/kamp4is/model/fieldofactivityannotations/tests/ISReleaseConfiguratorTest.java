...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>IS Release Configurator</b></em>'.
 * <!-- end-user-doc -->
 * @generated
 */
public class ISReleaseConfiguratorTest extends ISRoleTest {
	...
	/**
	 * Constructs a new IS Release Configurator test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public ISReleaseConfiguratorTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this IS Release Configurator test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	protected ISReleaseConfigurator getFixture() {
		return (ISReleaseConfigurator)fixture;
	}
