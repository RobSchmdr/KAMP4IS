...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>IS Build Configuration</b></em>'.
 * <!-- end-user-doc -->
 * @generated
 */
public class ISBuildConfigurationTest extends ISFileTest {
	...
	/**
	 * Constructs a new IS Build Configuration test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public ISBuildConfigurationTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this IS Build Configuration test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	protected ISBuildConfiguration getFixture() {
		return (ISBuildConfiguration)fixture;
	}
